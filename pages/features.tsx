    ...
    const features = [
        {
          ...
          icon: <MdOutlineDesignServices className="w-16 h-16 text-gray-500 dark:text-gray-700 mb-4" />
        },
        {
          title: "Smart Reminders",
          description: "Never miss what matters. Get notified at the right time.",
          icon: <IoNotifications className="w-16 h-16 text-gray-500 dark:text-gray-700 mb-4" />
        },
        {
          title: "Quick Setup",
          description: "Start organizing in seconds. No tutorials needed.",
          icon: <FiSettings className="w-16 h-16 text-gray-500 dark:text-gray-700 mb-4" />
        },
      ];
